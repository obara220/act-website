      ...
      <div className="p-6 w-full pr-6 pl-6">
        ...
        <div className="driver-content">
          <div className="text-center driver-container py-6">
            <p className="text-location">
              ...
              approximately{" "}
              <span className="text-blue-600 font-bold">5 minutes</span>.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between grid grid-cols-3 gap-6">
          ...
          <div className="driver-info-content">
            <div
              className="bg-gray-200 p-3 rounded-lg flex flex-col items-center mb-4"
              style={{ height: "249px" }}
            >
              <img
                src={Driver}
              ...
              />
              <h2 className="font-semibold mt-4" style={{ fontSize: "28px" }}>
                Joseph Smith
              </h2>
            ...
            <div
              onClick={toggleModal}
              className="bg-gray-200 justify-between  p-4 rounded-lg flex items-center mb-4 more-info-button"
            >
              <div>
                <FaInfoCircle />
              </div>
          ...
          >
            ...
            <div className="p-4 card-border">
              <div className="mb-3">
                ...
                <p className="font-semibold text-md">Terminal 4,</p>
                <p className="font-semibold text-md">Passenger Pickup Zone</p>
              </div>
            </div>
            <div className="p-4">
              <div>
                ...
                <div style={{ width: "48%" }}>
                  <div className="modal-driver-info">
                    <div className="modal-driver-info-header">
                      <p className="text-ssm font-semibold mb-2">
                        Driver Information
                      </p>
                    </div>
                  ...
                  <div className="mt-4 modal-driver-info">
                    <div className="modal-driver-info-header">
                      <h3 className="text-ssm font-semibold mb-2">
                        Safety Check
                      </h3>
                    </div>
                    {safetyArr.map((item) => (
                      <div
                        key={item.key}
                        className="flex justify-between items-center p-3 border-bottom-line"
                      >
                        <p className="m-0">{item.label}</p>
                        <label
                          className={`custom-checkbox ${
                            safetyCheck[item.key] ? "checked" : ""
                          }`}
                        >
                          <input
                            type="checkbox"
